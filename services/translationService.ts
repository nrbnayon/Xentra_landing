...
const MANUAL_GLOSSARY: StorageCache = {
  ...
  ht: {
    ...
    about: "Konsènan",
    contact: "Kontakte",
    "download the app now": "Telechaje aplikasyon an kounye a",
    "install now": "Enstale kounye a",
    "hero experience": "VIV",
    "hero sports": "ESPÒ",
    "hero like never before": "TANKOU JAMÈ ANVAN",
    "experience sports like never before": "VIV ESPÒ TANKOU JAMÈ ANVAN",
    ...
    "built for the next generation of sports fans.":
      "Kreye pou nouvo jenerasyon fanatik espò yo.",
    "we are focused on creating a next-generation sports platform with fast performance, real-time updates, secure transactions, and user-friendly experiences that keep fans connected to every moment of the game.":
      "Nou konsantre sou kreye yon platfòm espòtif nouvo jenerasyon ak gwo pèfòmans, mizajou an tan reyèl, tranzaksyon sekirize, ak yon eksperyans fasil pou itilize ki kenbe fanatik yo konekte ak chak moman jwèt la.",
    "real-time experience": "EKSPERYANS AN TAN REYÈL",
    "smart predictions": "PREDIKSYON ENTELIJAN",
    "global competition": "KONPETISYON MONDYAL",
    "secure & fair": "SEKIRIZE AK JIS",
    "stay updated with real-time scores, stats, and match highlights.":
      "Rete ajou ak rezilta, estatistik, ak pi bon moman match yo an tan reyèl.",
    "compete in live predictions and test your knowledge against fans worldwide.":
      "Patisipe nan prediksyon an dirèk epi teste konesans ou kont fanatik atravè lemond.",
    "play, compete, and climb the leaderboards across the world.":
      "Jwe, fè konpetisyon, epi monte nan klasman atravè lemond.",
    "transparent systems and a fair play environment you can trust.":
      "Sistèm transparan ak yon anviwònman jwèt ki jis ou ka fè konfyans.",
    "we're here to help!": "Nou la pou ede w!",
    "questions? reach out anytime, we're here":
      "Kesyon? Kontakte nou nenpòt ki lè, nou la pou ede w.",
    "get updates": "Resevwa mizajou yo",
    "enter your email to get updates":
      "Antre imel ou pou resevwa mizajou yo",
  ...
  fr: {
    ...
    "hero experience": "VIVEZ",
    "hero sports": "LE SPORT",
    "hero like never before": "COMME JAMAIS AUPARAVANT",
    "experience sports like never before": "VIVEZ LE SPORT COMME JAMAIS AUPARAVANT",
    experience: "Expérience",
    sports: "Sports",
    "like never before": "comme jamais auparavant",
    "join thousands of users enjoying live match updates, secure transactions, and an immersive sports experience designed for every fan.":
      "Rejoignez des milliers d’utilisateurs profitant des mises à jour des matchs en direct, de transactions sécurisées et d’une expérience sportive immersive conçue pour tous les fans.",
    "10k+ users": "Plus de 10k utilisateurs",
    users: "Utilisateurs",
    matches: "Matchs",
    "enjoy a seamless sports experience with advanced analytics, secure payments, and real-time match tracking designed to keep you ahead of the game.":
      "Profitez d’une expérience sportive fluide avec des analyses avancées, des paiements sécurisés et un suivi des matchs en temps réel conçu pour vous garder en avance sur le jeu.",
    "predict now": "Prédire maintenant",
    "learn more": "En savoir plus",
    "about us": "À propos de nous",
    "built for the next generation of sports fans.":
      "Conçu pour la nouvelle génération de fans de sport.",
    "we are focused on creating a next-generation sports platform with fast performance, real-time updates, secure transactions, and user-friendly experiences that keep fans connected to every moment of the game.":
      "Nous créons une plateforme sportive de nouvelle génération avec des performances rapides, des mises à jour en temps réel, des transactions sécurisées et une expérience conviviale qui permet aux fans de rester connectés à chaque moment du match.",
    ...
    "secure & fair": "SÉCURISÉ & ÉQUITABLE",
    "stay updated with real-time scores, stats, and match highlights.":
      "Restez informé avec les scores, statistiques et moments forts des matchs en temps réel.",
    "compete in live predictions and test your knowledge against fans worldwide.":
      "Participez aux prédictions en direct et testez vos connaissances contre des fans du monde entier.",
    "play, compete, and climb the leaderboards across the world.":
      "Jouez, affrontez d’autres joueurs et grimpez dans les classements mondiaux.",
    "transparent systems and a fair play environment you can trust.":
      "Des systèmes transparents et un environnement équitable auquel vous pouvez faire confiance.",
    "we're here to help!": "Nous sommes là pour vous aider !",
    "questions? reach out anytime, we're here":
      "Des questions ? Contactez-nous à tout moment, nous sommes là pour vous.",
    "get updates": "Recevez les mises à jour",
    "enter your email to get updates":
  ...
  es: {
    ...
    "hero experience": "VIVE",
    "hero sports": "EL DEPORTE",
    "hero like never before": "COMO NUNCA ANTES",
    "experience sports like never before": "VIVE EL DEPORTE COMO NUNCA ANTES",
    experience: "Experiencia",
    sports: "Deportes",
    "like never before": "como nunca antes",
    "join thousands of users enjoying live match updates, secure transactions, and an immersive sports experience designed for every fan.":
      "Únete a miles de usuarios que disfrutan de actualizaciones de partidos en vivo, transacciones seguras y una experiencia deportiva inmersiva diseñada para todos los fanáticos.",
    "10k+ users": "Más de 10k usuarios",
    users: "Usuarios",
    matches: "Partidos",
    "enjoy a seamless sports experience with advanced analytics, secure payments, and real-time match tracking designed to keep you ahead of the game.":
      "Disfruta de una experiencia deportiva fluida con análisis avanzados, pagos seguros y seguimiento de partidos en tiempo real diseñado para mantenerte siempre un paso adelante.",
    "predict now": "Predecir ahora",
    "learn more": "Saber más",
    "about us": "Acerca de nosotros",
    "built for the next generation of sports fans.":
      "Creado para la próxima generación de aficionados al deporte.",
    "we are focused on creating a next-generation sports platform with fast performance, real-time updates, secure transactions, and user-friendly experiences that keep fans connected to every moment of the game.":
      "Estamos enfocados en crear una plataforma deportiva de nueva generación con alto rendimiento, actualizaciones en tiempo real, transacciones seguras y experiencias fáciles de usar que mantienen a los fanáticos conectados a cada momento del juego.",
    "real-time experience": "EXPERIENCIA EN TIEMPO REAL",
    "smart predictions": "PREDICCIONES INTELIGENTES",
    "global competition": "COMPETENCIA GLOBAL",
    "secure & fair": "SEGURO Y JUSTO",
    "stay updated with real-time scores, stats, and match highlights.":
      "Mantente actualizado con resultados, estadísticas y momentos destacados en tiempo real.",
    "compete in live predictions and test your knowledge against fans worldwide.":
      "Compite en predicciones en vivo y pon a prueba tus conocimientos contra fanáticos de todo el mundo.",
    "play, compete, and climb the leaderboards across the world.":
      "Juega, compite y sube en las clasificaciones mundiales.",
    "transparent systems and a fair play environment you can trust.":
    ...
    "questions? reach out anytime, we're here":
      "¿Preguntas? Contáctanos en cualquier momento, estamos aquí para ayudarte.",
